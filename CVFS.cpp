...
void man(char *name)
{
    ...
    {
        printf("Description: Used to create a regular files\n");
        printf("Usage: create File_name Permission\n");
    }
    else if(strcmp(name,"read")==0)
    {
        printf("Description: Used to read a regular files\n");
    ...
    {
        printf("ERROR: No manual entry available for this command\n");
    }
}
...
void ls_file()
{
    ...
    {
        printf("ERROR: There is no file available");
        return;
    }
...
int fstat_file(int fd)
{
    ...
    printf("File Size: %s\n",temp->FileSize);
    printf("Actual File Size: %s\n",temp->FileActualSize);
    printf("Link Count: %s\n",temp->LinkCount);
    printf("Reference Count: %s\n",temp->ReferenceCount);
...
int main()
{
    ...
    while(1)
    {
        ...
        if(count==1)
        {
            ...
            {
                printf("terminating the Manjiri's Virtual File System\n");
                break;
            }
            else
            {
        ...
        else if(count==2)
        {
            if(strcmp(command[0],"stat")==0)
            {
                ...
                if(ret==-2)
                {
                    printf("ERROR: There is no such file found..\n");
                }
        ...
        else if(count==3)
        {
            if(strcmp(command[0],"create")==0)
            {
                ...
                if(ret==-2)
                {
                    printf("ERROR: There is no inode available\n");
                }
                if(ret==-3)
                {
